...
class Packet {
  ...
  const message = this.readString(undefined, encoding || "utf8") || "Mensaje no disponible";
console.log("📌 Mensaje de error recibido:", message);
let err = new Error(message);
err.code = ErrorCodeToName[errorCode] || "Código no identificado";
err.errno = errorCode || -1;
err.sqlState = sqlState || "Estado desconocido";
err.sqlMessage = message;


console.log("📌 Error generado:", err);
console.log("📌 Consulta SQL ejecutada:", this.sql || this.query);
return err;
